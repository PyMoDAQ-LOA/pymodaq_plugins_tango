...
class DAQ_2DViewer_Tango2DGeneric(DAQ_Viewer_base):

    config = TangoTomlConfig('analysis', Path(__file__).parents[2] / 'resources/config_tango.toml')
    ...
    def ini_attributes(self):
        ...
        self.tangoXCentroid = None
        self.tangoYCentroid = None
